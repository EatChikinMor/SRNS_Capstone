...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <asp:Label runat="server" ID="lblLiNum"><span style="color:red">*</span>License Key/Number</asp:Label>
            ...
            <div class="col-lg-4 col-md-4">
                <asp:Label runat="server" ID="lblDateExpiring"><span style="color:red">*</span>Date of Expiration</asp:Label>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                ...
                <div class="col-lg-6 col-md-6">
                    <asp:Panel runat="server" ID="pnlHolders">
                        <asp:Label runat="server" ID="lblLiComp"><span style="color:red">*</span>License Company</asp:Label>
                        <br/>
            ...
            <div class="col-lg-4 col-md-4">
                <asp:Label runat="server" ID="lblLiCost"><span style="color:red">*</span>License Cost (Decimal point required)</asp:Label>
        ...
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5">
                ...
                <br/>
                <h3>
                    <asp:Label runat="server" ID="lblLink" Text="Attachment:" Visible="False"></asp:Label>
